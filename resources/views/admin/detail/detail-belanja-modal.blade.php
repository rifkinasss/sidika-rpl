                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" class="form-control" id="nama_lengkap" value="{{ $barmod->user->nama }}"
                                disabled>
                        </div>
                        <div class="form-group col-sm-4">
                            <label for="nip">NIP</label>
                            <input type="text" class="form-control" id="nip" value="{{ $barmod->user->nip }}"
                                disabled>
                        </div>
                        <div class="form-group col-sm-4">
                            <label for="tgl_mengajukan">Waktu Pengajuan</label>
                            <input type="text" class="form-control" id="tgl_mengajukan"
                                value="{{ \Carbon\Carbon::parse($barmod->created_at)->format('(H:i) d M Y') }}" disabled>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-group col-sm-2">
                            ...
                            <div class="input-group">
                                <input type="text" id="jumlah-hari-kontrak-modal" class="form-control"
                                    aria-label="Amount (to the nearest dollar)"
                                    value="{{ $barmod->jumlah_hari_kontrak }}" disabled>
