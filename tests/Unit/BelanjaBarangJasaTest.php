...
class BelanjaBarangJasaTest extends TestCase
{
    public function testStoreBarangJasa()
    {
        ...
        $response = $this->post(route('belanja-barang-jasa.store'), $request->all());

        // Assert redirect
        $response->assertRedirect();

        // Assert database has the created record
        $this->assertDatabaseHas('barang_jasa', [
            'user_id' => $user->id,
